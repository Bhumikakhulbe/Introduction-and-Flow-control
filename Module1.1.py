...
elif(x=='2' or x=='rectangle' or x=='Rectangle'): #checks the given condition and if stands true will print the given statement
...
elif(x=='3' or x=='Square' or x=='square'):  #checks the given condition and if stands true will print the given statement
...
elif(x=='4' or x=='Triangle' or x=='triangle'):  #checks the given condition and if stands true will print the given statement
